...
class DiscretizedMixtureLogitsDistribution_1d(Distribution):
    def __init__(self, nr_mix, logits):
        self.logits = logits
        self.nr_mix = nr_mix

    def log_prob(self, value):
        return - discretized_mix_logistic_loss_1d(value, self.logits)

    def sample(self):
        return sample_from_discretized_mix_logistic_1d(self.logits, self.nr_mix)


class DiscretizedMixtureLogits_1d():

    def __init__(self, nr_mix, **kwargs):
        self.nr_mix = nr_mix

    def __call__(self, logits):
        return DiscretizedMixtureLogitsDistribution_1d(self.nr_mix, logits)
