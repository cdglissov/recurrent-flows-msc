...
class Solver(object):
    ...
    def plotter(self):
      ...
      with torch.no_grad():
        ...
        recons, recons_flow = self.model.reconstruct(image)
      ...
      fig, ax = plt.subplots(5, time_steps , figsize = (15,10))
      for i in range(0, time_steps):
        ...
        ax[4,i].imshow(self.convert_to_numpy(recons[i, 0, :, :, :]))
        ax[4,i].set_title("Recon-Bijection")
        ax[4,i].axis('off')
