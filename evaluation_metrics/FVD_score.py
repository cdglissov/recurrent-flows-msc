...
from evaluation_metrics.FVD import calculate_fvd, create_id3_embedding, preprocess
...
def fvd(real, fake):
    ...
    real = real.permute(1, 0, 3, 4, 2).contiguous()
    fake = fake.permute(1, 0, 3, 4, 2).contiguous() 
