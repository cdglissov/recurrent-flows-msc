    ...
    def train(self):
      ...
      for epoch_i in range(self.n_epochs):
          ...
          if self.epoch_i % 1 == 0:
            ...
            self.checkpoint('srnn_hier.pt', self.epoch_i, epoch_loss)
          ...
          if (self.earlystopping.best_loss < self.best_loss) and (self.epoch_i > 50):
            ...
            self.checkpoint('srnn_hier_best_model.pt', self.epoch_i, epoch_loss)
